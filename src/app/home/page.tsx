    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[70vh] min-h-[420px] overflow-hidden">
        ...
        <div className="relative flex h-full flex-col items-center justify-center px-4 py-16 text-center">
          ...
          <p
            className="mt-8 w-full max-w-6xl px-4 pr-[calc(1rem+150px)] text-right text-xl font-semibold tracking-wide text-brand-200/95 drop-shadow-[0_1px_2px_rgba(0,0,0,0.2)]"
